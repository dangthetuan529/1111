...
namespace BTL_Nhom1
{
    public partial class FrmSach : Form
    {
        ...
        private void FrmSach_Load(object sender, EventArgs e)
        {
            ...
            Funtions.FillDataToCombo(sqla, cbMaTheLoai7, "MaTheLoai","TenTheLoai");
            string sqlb = "Select MaNgonNgu , TenNgonNgu from NgonNgu";
            Funtions.FillDataToCombo(sqlb, cbMaNgonNgu7, "MaNgonNgu","TenNgonNgu");
            string sqlc = "Select MaNXB , TenNXB from NHAXUATBAN";
            Funtions.FillDataToCombo(sqlc, cbMaNXB7, "MaNXB","TenNXB");
        ...
        private void dataGridViewS_Click(object sender, EventArgs e)
        {
            ...
            cbMaNgonNgu7.Text = Funtions.GetFieldValues("select TenNgonNgu from NgonNgu where MaNgonNgu = N'" + mann + "'");
            ...
            cbMaTheLoai7.Text = Funtions.GetFieldValues("select TenTheLoai from theloai where MaTheLoai = N'" + matl + "'");
            ...
            cbMaNXB7.Text = Funtions.GetFieldValues("select TenNXB from nhaxuatban where MaNXB = N'" + manxb + "'");
        }
