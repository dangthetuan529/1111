...
namespace BTL_Nhom1
{
    public partial class FrmHoSoMuon : Form
    {
        ...
        private void groupHSM_Enter(object sender, EventArgs e)
        {
            ...
            Funtions.FillDataToCombo(sqla, cbMaTheMuon3, "MaTheMuon","MaTheMuon");
            string sqlb = "Select MaThuThu from ThuThu";
            Funtions.FillDataToCombo(sqlb, cbMaThuThu3, "MaThuThu","MaTheMuon");
        ...
        private void groupBoxCTHSM_Enter(object sender, EventArgs e)
        {
            ...
            Funtions.FillDataToCombo(sqlc, cbMaHSM7, "MaHSM","MaHSM");
            string sqld = "Select MaSach from Sach";
            Funtions.FillDataToCombo(sqld, cbMaSach7, "MaSach","MaSach");
