...
namespace BTL_Nhom1
{
    public partial class FrmHoSoTra : Form
    {
        ...
        private void groupHST_Enter(object sender, EventArgs e)
        {
            ...
            Funtions.FillDataToCombo(sqla, cbMaHSM2, "MaHSM","MaHSM");
            string sqlb = "Select MaThuThu from ThuThu";
            Funtions.FillDataToCombo(sqlb, cbMaThuThu2, "MaThuThu","MaThuThu");
        ...
        private void groupCTHST_Enter(object sender, EventArgs e)
        {
            ...
            Funtions.FillDataToCombo(sqla, cbMaHST9, "MaHST", "MaHST");
            string sqlb = "Select MaSach from Sach";
            Funtions.FillDataToCombo(sqlb, cbMaSach9, "MaSach", "MaSach");
            string sqlc = "Select MaViPham from ViPham";
            Funtions.FillDataToCombo(sqlc, cbMaViPham9, "MaViPham", "MaViPham");
        }
